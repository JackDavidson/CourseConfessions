...
public class phpInteractions {
     ...
     * @return TODO
     */
    public static ArrayList<String> getListOfCourses(String courseSection, int lowNumber,
            int highNumber) {
        /*
        ...
        //nameValuePairs.add(new BasicNameValuePair("password", userPass));
    	//String page = new Communicator().executeHttpGet("http://www.courseconfessions.com/androidgetcourselist.php");
        HttpGet httpget = new HttpGet("http://www.courseconfessions.com/androidgetcourselist.php");
    ...
    {
        ArrayList<String> list = new ArrayList<String>(); // where the list of courses will be held
        try {
