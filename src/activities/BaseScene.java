...
public class BaseScene extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		sideMenuIcon.setX(100);
		sideMenuIcon.setY(100);
		...
		sideMenuHome.setX(200);
		sideMenuHome.setY(760);
		...
		sideMenuCourses.setX(200);
		sideMenuCourses.setY(880);
		...
		sideMenuRatings.setX(200);
		sideMenuRatings.setY(1000);
		...
		sideMenuSettings.setX(200);
		sideMenuSettings.setY(1120);
		...
		sideMenuLogout.setX(200);
		sideMenuLogout.setY(1240);
	...
	public enum Screen {
		HomeScreen, SignupScreen, ForgotScreen, MainMenuScreen, CourseSelectScreen, WriteReviewScreen
	}
}
